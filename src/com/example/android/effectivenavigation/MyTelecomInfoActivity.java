        ...
        public Fragment getItem(int i) {
             ...
             */
                ...
                case outGoingPageNum:
                    ...
                    return new CallLogCursorLoaderFragment(CallLog.Calls.OUTGOING_TYPE);

                case inComingPageNum:

                    return new CallLogCursorLoaderFragment(CallLog.Calls.INCOMING_TYPE);

                case missedPageNum:

                    return new CallLogCursorLoaderFragment(CallLog.Calls.MISSED_TYPE);
