...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public static final int outGoingPageNum = 0;
        public static final int inComingPageNum = 1;
        public static final int  missedPageNum = 2;
        public static final int callInfoPageNum = 3;
        ...
        public Fragment getItem(int i) {
            switch (i) {
                ...
                case outGoingPageNum:
                    //return new CallLogCursorLoader(outGoing);
                    return new CallLogCursorLoader(CallLog.Calls.OUTGOING_TYPE);
                
                case inComingPageNum:
                    //return new CallLogCursorLoader(inComing);
                    return new CallLogCursorLoader(CallLog.Calls.INCOMING_TYPE);
                
                case missedPageNum:
                    //return new CallLogCursorLoader(missed);
                    return new CallLogCursorLoader(CallLog.Calls.MISSED_TYPE);
            ...
            rootView.findViewById(R.id.demo_external_activity).setOnClickListener(
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            externalActivityIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
